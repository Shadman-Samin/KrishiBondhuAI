...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Untitled Farming AI Companion — Bangladesh's AI-Powered Farming Assistant" },
      ...
      { property: "og:title", content: "Untitled Farming AI Companion — Bangladesh's AI-Powered Farming Assistant" },
      ...
      { name: "twitter:title", content: "Untitled Farming AI Companion — Bangladesh's AI-Powered Farming Assistant" },
