...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Untitled Farming AI Companion" },
      { property: "og:description", content: "Empowering Bangladesh's agriculture through localized AI, satellite intelligence, and voice-first interaction." },
